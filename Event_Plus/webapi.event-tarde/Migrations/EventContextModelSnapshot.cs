...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webapi.event_tarde.Domains.Instituicao", b =>
                {
                    b.Property<Guid>("IdInstituicao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("webapi.event_tarde.Domains.PresencaEvento", b =>
                {
            ...
            modelBuilder.Entity("webapi.event_tarde.Domains.TipoEvento", b =>
                {
                    b.Property<Guid>("IdTipoEvento")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("webapi.event_tarde.Domains.TipoUsuario", b =>
                {
            ...
            modelBuilder.Entity("webapi.event_tarde.Domains.Evento", b =>
                {
                    b.HasOne("webapi.event_tarde.Domains.Instituicao", "Instituicao")
                        .WithMany()
                        .HasForeignKey("IdInstituicao")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("webapi.event_tarde.Domains.TipoEvento", "TipoEvento")
                        .WithMany()
            ...
            modelBuilder.Entity("webapi.event_tarde.Domains.Usuario", b =>
                {
                    b.HasOne("webapi.event_tarde.Domains.TipoUsuario", "TipoUsuario")
                        .WithMany()
